...
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "导出 TXT 映射文件" "Hubei report optional TXT mapping export"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "创建属性集明细表（排除项目信息）" "Hubei report optional property set schedules"
