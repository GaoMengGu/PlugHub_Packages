...
Require-File "src\PlugHub.HubeiReportParameters\HubeiReportSchedulePlanner.cs"
Require-File "src\PlugHub.HubeiReportParameters\HubeiReportScheduleCreator.cs"
Require-File "tests\PlugHub.HubeiReportParameters.TemplateValidation\Program.cs"
Require-File "tests\PlugHub.HubeiReportParameters.SchedulePlanningValidation\Program.cs"
Require-File "tests\PlugHub.HubeiReportParameters.SchedulePlanningValidation\PlugHub.HubeiReportParameters.SchedulePlanningValidation.csproj"
...
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportTemplate.cs" 'row.RevitParameterName = row.PropertySetName + "_" + row.Name;' "Hubei report property-set-qualified Revit parameter names"
...
Require-Text "src\PlugHub.HubeiReportParameters\RevitCategoryCatalog.cs" "OST_Topography" "Hubei report topography category support"
Require-Text "src\PlugHub.HubeiReportParameters\RevitCategoryCatalog.cs" "document.Settings.Categories" "Hubei report dynamic project category catalog"
Require-Text "src\PlugHub.HubeiReportParameters\RevitCategoryCatalog.cs" "category.AllowsBoundParameters" "Hubei report bindable category filtering"
Require-Text "src\PlugHub.HubeiReportParameters\RevitCategoryCatalog.cs" "category.Name" "Hubei report Revit category name resolution"
...
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_defaultValueRadioButton" "Hubei report default value mode"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_actualValueRadioButton" "Hubei report actual value mode"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_noValueRadioButton" "Hubei report no value mode"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "不写入数据" "Hubei report no value mode label"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_actualValueRadioButton.Checked = true" "Hubei report actual value default selection"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportParametersModels.cs" "HubeiReportValueMode" "Hubei report value mode model"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "导出项目名-HIFC.txt 映射文件" "Hubei report optional TXT mapping export"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "创建属性集明细表" "Hubei report optional property set schedules"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_executeButton.Enabled = !string.IsNullOrWhiteSpace" "Hubei report template selection execution guard"
...
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSchedulePlanner.cs" "IsProjectInformation" "Hubei report Project Information schedule exclusion"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSchedulePlanner.cs" "FilterParameterName" "Hubei report multi-category common filter parameter"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportScheduleCreator.cs" "ColumnHeading" "Hubei report schedule property headings"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportScheduleCreator.cs" "ViewSchedule.CreateSchedule" "Hubei report schedule creation"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportScheduleCreator.cs" "AreaScheme" "Hubei report area schedule support"
...
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "TransactionGroup" "Hubei report atomic parameter and schedule changes"
...
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportParametersModels.cs" "valueMode == HubeiReportValueMode.ActualValue ? ActualValue : DefaultValue" "Hubei report selected value source"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportParametersModels.cs" "valueMode != HubeiReportValueMode.ActualValue || !string.IsNullOrWhiteSpace(ActualValue)" "Hubei report empty actual value detection"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "if (!definition.HasValue(valueMode))" "Hubei report empty actual value assignment skip"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "真实数据为空时跳过赋值" "Hubei report empty actual value UI hint"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "valueMode != HubeiReportValueMode.None" "Hubei report no-value transaction guard"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportTemplate.cs" "ValidateDuplicateNames(template.Rows, valueMode)" "Hubei report value conflict validation follows selected mode"
Reject-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_writeActualValuesCheckBox" "Hubei report legacy actual value checkbox"
...
Require-Text ".github\workflows\build-package.yml" '      - "**"' "All branches trigger DLL builds"
Require-Text ".github\workflows\build-package.yml" 'if: github.actor != ''github-actions[bot]'' && github.event_name == ''push'' && github.ref_type == ''branch'' && github.ref != ''refs/heads/main''' "Package output commit non-main branch rule"
