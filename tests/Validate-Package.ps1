...
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "using System.Linq;" "Hubei report command LINQ scope checks"
...
Reject-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_globalCheckBox.Checked = false;" "Hubei report mini option clearing global selection"
Reject-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_totalPlanCheckBox.Checked = false;" "Hubei report mini option clearing total plan selection"
Reject-Text "src\PlugHub.HubeiReportParameters\HubeiReportSelectionForm.cs" "_monolithicCheckBox.Checked = false;" "Hubei report mini option clearing monolithic selection"
...
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportCatalog.cs" "FindHifcDefinition" "Hubei report mini parameters must preserve HIFC Pset mapping"
Require-Text "src\PlugHub.HubeiReportParameters\HubeiReportCatalog.cs" "GetScopedDefinitions(HubeiReportSource.Mini" "Hubei report mini parameters must be filtered by selected scopes"
Reject-Text "src\PlugHub.HubeiReportParameters\HubeiReportCatalog.cs" "DetermineMiniScopes" "Hubei report mini parameter heuristic scope mapping"
Reject-Text "src\PlugHub.HubeiReportParameters\HubeiReportCatalog.cs" "definition.Source == HubeiReportSource.Mini).ToArray()" "Hubei report unfiltered mini parameter creation"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "IfcTypeNames" "Hubei report command must bind by precise IFC type metadata"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_ProjectInformation" "Hubei report IfcProject and IfcBuilding project information binding"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Site" "Hubei report IfcSite binding"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Levels" "Hubei report IfcBuildingStorey binding"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Rooms" "Hubei report IfcSpace and IfcSpatialZone room binding"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_MEPSpaces" "Hubei report IfcSpace and IfcSpatialZone space binding"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Areas" "Hubei report IfcSpace and IfcSpatialZone area binding"
Require-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Floors" "Hubei report IfcSlab floor binding"
Reject-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_GenericModel" "Hubei report broad total-plan generic model binding"
Reject-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Walls" "Hubei report broad monolithic wall binding"
Reject-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Roofs" "Hubei report broad monolithic roof binding"
Reject-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Columns" "Hubei report broad monolithic column binding"
Reject-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_StructuralColumns" "Hubei report broad monolithic structural column binding"
Reject-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_StructuralFraming" "Hubei report broad monolithic structural framing binding"
Reject-Text "src\PlugHub.HubeiReportParameters\SyncHubeiReportParametersCommand.cs" "OST_Ceilings" "Hubei report broad monolithic ceiling binding"
